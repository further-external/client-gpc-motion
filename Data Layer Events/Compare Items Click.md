...
| **ctaDetail** | string | Detailed description of the CTA link | ati tools, cutting tools, Sign up, Start Building, Request Quote, Add to Cart, Shop Now - hero image, Shop Product |
