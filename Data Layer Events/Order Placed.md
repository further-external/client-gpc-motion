...
| **currency** | string | Currency of the transaction. ISO 4217 (3 character alpha), uppercase | USD, CAD, GBP, CHF |
...
| **specialPricingFlag** | boolean | A flag representing if the product is currently seen or purchased at a promotional price. | true, false |
