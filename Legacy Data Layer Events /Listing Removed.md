...
When a listing item is removed , the following information will want to be known for the individual item that was removed. An item is considered “removed” when for example it is being exclude from a product comparison page.
